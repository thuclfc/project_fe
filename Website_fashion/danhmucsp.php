...
<?php
    $sql_product="Select MaHang,TenMH,HinhAnh,MoTa,concat('$', Gia_ban) from mathang";
    ...
    $x=($p-1) * $sodong;
    $sql_product1="Select MaHang,TenMH,HinhAnh,MoTa,concat('$', Gia_ban) from mathang limit $x, $sodong";
